package com.icoin.money.converter;
...
public final class JodaMoneyConverter implements Converter {
    ...
    public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
        ...
        try {
            ...
            throw new XStreamException(String.format("Cannot support deserializing Type : %s", requiredType.getSimpleName()));
        } catch (Exception e) { // NOSONAR
            throw new XStreamException(String.format(
