...
keytool -export -rfc -keystore serviceKeystore.jks -alias myservicekey -file coinService.cer -storepass sspass
keytool -import -noprompt -trustcacerts -file coinService.cer -alias myservicekey -keystore clientKeystore.jks -storepass cspass
...
keytool -export -rfc -keystore clientKeystore.jks -alias myclientkey -file tradingClient.cer -storepass cspass
keytool -import -noprompt -trustcacerts -file tradingClient.cer -alias myclientkey -keystore serviceKeystore.jks -storepass sspass