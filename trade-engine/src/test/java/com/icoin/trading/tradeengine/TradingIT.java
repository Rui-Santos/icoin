...
public class TradingIT {
    ...
    public void setUp() throws Exception {
        ...
        addItems(userId2, "BTC", btcAmount);
    ...
    public void testExecuteOneExactOrder() throws Exception {
        ...
        placeBuyOrder(orderBookEntry, buyPortfolio, tradeAmount, price, buyTransactionId);
        ...
        /****************************data***************************************** 
         ...
         price: 12.456 
         amount: 5.133412 
         commission: 0.005%                                         commission: 65.187 * 0.005% = 0.326 
         ...
         price: 12.456 
         amount: 5.133412 
         commission: 0.005%                                         commission: 5.133412 * 0.005% = 0.02566706 
        ...
        assertThat(orderBook.getHighestBuyPrice().isEqual(BigMoney.of(Constants.DEFAULT_CURRENCY_UNIT, Constants.INIT_SELL_PRICE)), is(true));
