 ...
 */
public class StartBuyCommissionTransactionCommand extends StartCommissionTransactionCommand<StartBuyCommissionTransactionCommand> {
    public StartBuyCommissionTransactionCommand(FeeTransactionId feeTransactionId,
                                                FeeId receivedFeeId,
