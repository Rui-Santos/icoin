 ...
 */
public class ExecutedPayMoneyTransactionStartedEvent extends ExecutedTransactionStartedEvent<ExecutedPayMoneyTransactionStartedEvent> {
    protected final FeeId paidFeeId;
    protected final FeeId accountPayableFeeId;

    public ExecutedPayMoneyTransactionStartedEvent(FeeTransactionId feeTransactionId,
                                                   FeeId paidFeeId,
