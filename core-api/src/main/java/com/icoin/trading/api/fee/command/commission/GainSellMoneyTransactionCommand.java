 ...
 */
public class GainSellMoneyTransactionCommand extends ReceiveTransactionCommand<GainSellMoneyTransactionCommand> {
    public GainSellMoneyTransactionCommand(FeeTransactionId feeTransactionId,
                                           FeeId receivedFeeId,
