 ...
 */
public class ExecutedReceiveCoinTransactionStartedEvent extends ExecutedTransactionStartedEvent<ExecutedReceiveCoinTransactionStartedEvent> {
    protected final FeeId receivedFeeId;
    protected final FeeId accountReceivableFeeId;

    public ExecutedReceiveCoinTransactionStartedEvent(FeeTransactionId feeTransactionId,
                                                      FeeId receivedFeeId,
