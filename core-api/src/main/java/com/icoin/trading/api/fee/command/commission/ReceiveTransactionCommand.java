 ...
 */
public class ReceiveTransactionCommand<T extends ReceiveTransactionCommand> extends ExecutionTransactionCommand<T> {
    @NotNull
    protected final FeeId receivedFeeId;
    @NotNull
    protected final FeeId accountReceivableFeeId;

    public ReceiveTransactionCommand(FeeTransactionId feeTransactionId,
                                     FeeId receivedFeeId,
