 ...
 */
public class PaySellCoinTransactionCommand extends PayTransactionCommand<PaySellCoinTransactionCommand> {
    public PaySellCoinTransactionCommand(FeeTransactionId feeTransactionId,
                                         FeeId paidFeeId,
