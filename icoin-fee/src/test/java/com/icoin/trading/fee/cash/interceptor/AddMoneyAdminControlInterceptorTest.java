 ...
 */
public class AddMoneyAdminControlInterceptorTest {
    @Test
    public void testAllowed() throws Exception {
        ...
        cashAdmin.enableAddingMoney();
        when(repository.findAll()).thenReturn(null, Collections.EMPTY_LIST, Arrays.asList(cashAdmin));

        final AddMoneyAdminControlInterceptor interceptor = new AddMoneyAdminControlInterceptor();
