 ...
 */
public class ReceiveSoldCoinFeeManagerSagaTest {
    ...
    private BigMoney soldCoin = BigMoney.of(CurrencyUnit.of("BTC"), 120.23);

    @Before
    public void setUp() throws Exception {
        fixture = new AnnotatedSagaTestFixture(ReceiveSoldCoinFeeManagerSaga.class);
    }
    ...
    public void testStarted() throws Exception {
        fixture.givenAggregate(feeTransactionId).published()
                ...
                new ExecutedReceiveCoinTransactionStartedEvent(
                        feeTransactionId,
                        receivedFeeId,
                ...
                .expectDispatchedCommandsEqualTo(
                        ...
                        new CreateOffsetCommand(
                                ...
                                portfolioId.toString(),
                                ImmutableList.of(new FeeItem(accountReceivableFeeId.toString(), FeeItemType.AR, soldCoin)),
                                ImmutableList.of(new FeeItem(receivedFeeId.toString(), FeeItemType.RECEIVED, soldCoin)),
                                soldCoin,
                                tradeTime));
