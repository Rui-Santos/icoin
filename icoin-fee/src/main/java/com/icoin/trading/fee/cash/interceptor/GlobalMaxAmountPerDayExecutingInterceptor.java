 ...
 */
public class GlobalMaxAmountPerDayExecutingInterceptor extends ProfilingInterceptor {
    ...
    protected ValidationCode doIntercept(Invocation invocation) {
        ...
        final List<Cash> list = cashRepository.findByDueDate(service.computeDueDate(context.getOccurringTime()));
        ...
        return maxAmount.isLessThan(amount) ? ValidationCode.EXCEEDED_GLOBAL_MAX_AMOUNT_PER_DAY : null;
    }
