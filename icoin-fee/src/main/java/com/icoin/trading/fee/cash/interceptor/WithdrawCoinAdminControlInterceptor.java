 ...
 */
public class WithdrawCoinAdminControlInterceptor extends AbstractAdminControlInterceptor {
    ...
    protected ValidationCode doIntercept(Invocation invocation) {
        ...
        return admin.canWithdrawCoin() ? null : ValidationCode.SYSTEM_DISALLOWED;
    }
}
